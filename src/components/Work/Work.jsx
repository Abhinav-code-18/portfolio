            ...
            <div className="flex flex-col">
              ...
              <div className="lg:p-8 p-6">
                ...
                <div className="flex gap-4">
                  ...
                  className="w-1/2 bg-gray-800 hover:bg-purple-800 text-gray-400 lg:px-6 lg:py-2 px-2 py-1 mt-6 rounded-xl lg:text-xl text-sm font-semibold text-center">
                    View Code
                  </a>
                  <a href={selectedProject.webapp} target="_blank" rel="noopener noreferrer"
                  className="w-1/2 bg-purple-600 hover:bg-purple-800 text-white lg:px-6 lg:py-2 px-2 py-1 mt-6 rounded-xl lg:text-xl text-sm font-semibold text-center">
                    View Live
                  </a>
                </div>
              </div>
